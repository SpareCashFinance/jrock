...
import { displayValue, eligibilityCopy, hasBurnTx, holderFeePercent, project } from "@/lib/config";
...
const rows = [
  ...
  },
  {
    ...
    value: displayValue(project.transferFee, `${holderFeePercent}% Token-2022 tax, paid in WBTC`),
  },
  { label: "Holder eligibility", value: eligibilityCopy() },
