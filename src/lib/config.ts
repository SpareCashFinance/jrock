...
export const copy = {
  ...
  story: [
    ...
    },
    {
      ...
      body: "Eligible holders may receive variable WBTC. Same rock. Higher standards.",
    },
  ],
  steps: [
    {
    ...
    },
    {
      n: "03",
      title: "Get fed WBTC",
      body: "Eligible holders may receive variable WBTC distributions. Same rock. Higher standards.",
    },
  ],
  caveats: [
    ...
    "Eligibility and distribution rules are controlled by the live implementation.",
