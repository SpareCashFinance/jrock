...
async function verifyV2(
  ...
  return {
    ...
    limitations: [
      ...
      "The book holds 10,000 buy rows this round (1–20 slips each) and shrinks unused reserved rows so leftover realloc rent stays in the pot. Explorer verification is filed against SpareCashFinance/jrock-lotto.",
